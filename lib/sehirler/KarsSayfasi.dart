class KarsSayfasi extends StatefulWidget {
  const KarsSayfasi({super.key});

  @override
  _KarsSayfasiState createState() => _KarsSayfasiState();
}

class _KarsSayfasiState extends State<KarsSayfasi> {
  @override
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              if (provider.favoriSehirler.contains('Kars')) {
                provider.removeFavoriSehir('Kars');
              } else {
                provider.addFavoriSehir('Kars');
              }

              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(
                    provider.favoriSehirler.contains('Kars')
                        ? 'Kars favorilere eklendi!'
                        : 'Kars favorilerden çıkarıldı!',
                  ),
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              if (provider.gidilenSehirler.contains('Kars')) {
                provider.removeGidilenSehir('Kars');
              } else {
                provider.addGidilenSehir('Kars');
              }

              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(
                    provider.gidilenSehirler.contains('Kars')
                        ? 'Kars gidilen şehirlere eklendi!'
                        : 'Kars gidilen şehirlerden çıkarıldı!',
                  ),
                  duration: const Duration(seconds: 2),
                ),
              );
                      ...
                      ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const YerSayfasiKars(),
                            ),
                          );
                        },
                      ...
                      ElevatedButton(
                        onPressed: () {
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                              const WeatherPage(cityName: 'Kars'),
                            ),
                          );
                        },
                        style: ElevatedButton.styleFrom(
